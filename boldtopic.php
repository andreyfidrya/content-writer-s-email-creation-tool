...
if ($_POST['topic']!='realestate' && $_POST['topic']!='marketing' && $_POST['topic']!='travel' && $_POST['topic']!='pestcontrol' && $_POST['topic']!= 'seooptimization' && $_POST['topic']!= 'cleaning' && $_POST['topic']!='dental' && $_POST['topic']!='medical'){
